...
public class NotificationDmpl implements NotificationDAO {
    ...
    public List<Notification> getNotificationByTask(Task t){
        ...
        try {
            Connection connection=new SingletonConnexionDB().getConnexion();
            PreparedStatement pstm=connection.prepareStatement("select n.ID,n.TITLE,n.DATE,n.DESCRIPTION,n.TASK_ID,n.INTERVENANT from notification n,task t where n.TASK_ID=t.ID and t.ID=?");
    ...
    public List<Notification> getNotificationByIntervenant(Intervenant i) {
        ...
        try {
            Connection connection=new SingletonConnexionDB().getConnexion();
            PreparedStatement pstm=connection.prepareStatement("select n.ID,n.TITLE,n.DATE,n.DESCRIPTION,n.TASK_ID,n.INTERVENANT from notification n,user i where i.isIntervenant=true and i.ID=n.INTERVENANT_ID and n.INTERVENANT_ID=?");
