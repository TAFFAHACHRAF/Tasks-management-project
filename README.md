...
L’objectif de ce projet de ce projet est le développement d’une application en JAVA pour
gérer les projets d’une entreprise. Cette application va permettre de gérer les tâches du projets,les ressources, et affiche la planification dans diagramme de Gantt.
